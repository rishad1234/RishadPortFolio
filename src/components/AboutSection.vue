...
const stats = ref([
    ...
    { title: 'Happy Clients', value: '30+', icon: 'mdi-account-heart' },
    { title: 'Cups of Coffee', value: '1000+', icon: 'mdi-coffee' },
])
</script>
        ...
        <v-container>
            ...
            <v-row align="center">
                <v-col cols="12" md="6">
                    <div class="about-content">
                        ...
                        <v-btn color="primary" size="large" class="mt-4" @click="downloadCV">
                    ...
                    <v-card class="pa-4">
                        ...
                        <v-card-text>
                            <div v-for="skill in skills" :key="skill.name" class="mb-4">
                                ...
                                <v-progress-linear :model-value="skill.level" :color="skill.color" height="8" rounded />
                            </div>
                        </v-card-text>
                    </v-card>
                </v-col>
            ...
            <v-row class="mt-12">
                <v-col cols="12" class="text-center mb-6">
                    <h3 class="text-h4 font-weight-bold">By the Numbers</h3>
                </v-col>

                <v-col v-for="stat in stats" :key="stat.title" cols="6" md="3">
                    <v-card class="text-center pa-4" elevation="2">
                        <v-icon :icon="stat.icon" size="48" color="primary" class="mb-2" />
